...
fn create_tag(
    ...
    diesel::insert_into(gps_real_time::table)
        .values(&new_tag)
        .returning(GpsTag::as_returning())
        .get_result(conn)
